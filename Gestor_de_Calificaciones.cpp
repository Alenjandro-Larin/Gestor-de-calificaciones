...
void Cuatrimestre1::SetNotas() {
 ...
 for (size_t i = 0; i < arrayDeMaterias.size(); i++) {
     ...
     asignaturas.arrayDeNotas.push_back(pNota);
 }
}
...
void Cuatrimestre1::GetNotas() {
    ...
    if (asignaturas.arrayDeNotas.empty()) {
    ...
    // Mostrar las notas
    for (size_t i = 0; i < arrayDeMaterias.size(); i++) {
        cout << "La nota de " << arrayDeMaterias[i] << " es: " << asignaturas.arrayDeNotas[i] << endl;
    }
}
...
void  Cuatrimestre1::SetPromedio(){
    float promedio;
     ...
     for (int i = 0; i < asignaturas.arrayDeNotas.size(); ++i) {
        
        asignaturas.arrayDeNotas[i] = asignaturas.arrayDeNotas[i]/5;
        promedio += asignaturas.arrayDeNotas[i];
    }
